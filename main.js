...
const startTimer = () => {
    ...
    // TODO: заменить timerState.pomodoro на общее
    timerState.time = timerState.remainedTime !== null
        ? timerState.remainedTime
        : timerState.pomodoro * 60000;
...
const resetTimer = () => {
    ...
    // TODO: Сбрасывать таймер на вкладке
    minutes.textContent = Math.floor(timerState.time / 60000);
